...
# habitaciones
svc.spreadsheets().values().update(
    spreadsheetId=sheet_id, range='habitaciones!A1:F6',
    valueInputOption='USER_ENTERED',
    body={'values': [
        ['nombre', 'precio', 'descripcion', 'imagen_url', 'activo', 'orden'],
        ...
        ['Cabaña Completa', '65000', 'Cabaña independiente con cochera, parrilla, cocina completa y vistas 360° de la Cordillera de los Andes.', '', 'SI', '4'],
